...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "初級者から上級者まで、幅広いレベルの方にご利用いただけます。オンボーディングで設定したレベルに応じて、お題の難易度や推奨語数が調整されます。",
  },
  {
    category: "サービスについて",
    question: "スマートフォンでも使えますか？",
    answer: "はい、スマートフォンのブラウザからもご利用いただけます。ただし、長文の入力にはパソコンやタブレットの方が快適にお使いいただけます。",
  },
  // 料金・プラン
  {
    category: "料金・プラン",
    question: "無料プランでも添削の品質は同じですか？",
    answer: "無料プランでは標準モデル（GPT-4o-mini）を使用しています。Proプランでは最新のGPT-4oモデルによる、より精度の高いフィードバックを受けられます。",
  },
  {
    category: "料金・プラン",
    question: "トークンとは何ですか？",
  ...
  },
  {
    ...
    answer: "はい、いつでも解約可能です。解約後も、お支払い済みの期間が終了するまではサービスをご利用いただけます。",
  },
  {
    category: "料金・プラン",
    question: "返金はできますか？",
    answer: "デジタルコンテンツの性質上、お支払い後の返金は原則としてお受けしておりません。まずは無料プランでお試しいただくことをおすすめします。",
  },
  // 機能について
  {
    category: "機能について",
    question: "4つのライティングモードの違いは何ですか？",
    answer: "「目標特化」はビジネス・試験など目標に直結するお題、「趣味・興味」は楽しく書けるテーマ、「表現リクエスト」は特定の英語表現を練習するモード、「カスタム」は自由にお題を設定できるモードです。",
  },
  {
    category: "機能について",
    question: "単語帳に保存した単語はどこで確認できますか？",
    answer: "ダッシュボードのナビゲーションから「単語帳」にアクセスできます。添削結果画面からワンタップで単語や表現を保存でき、後からまとめて復習できます。",
  },
  {
    category: "機能について",
    question: "学習履歴はどのくらい保存されますか？",
    answer: "無料プランでは7日間、Proプランでは無制限に学習履歴を保存できます。過去のライティングを振り返って復習することが可能です。",
  },
  // アカウント
  {
    category: "アカウント",
    question: "アカウントを削除するにはどうすればいいですか？",
    answer: "設定画面の最下部にある「アカウント削除」ボタンから削除できます。削除すると、すべての学習データが完全に削除され、復元できませんのでご注意ください。",
  },
  {
    category: "アカウント",
    question: "Googleアカウント以外でログインできますか？",
    answer: "現在はGoogleアカウントのみに対応しています。今後、他の認証方法の追加も検討しています。",
  },
];
